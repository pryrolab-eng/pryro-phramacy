      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gray-950">
        ...
        <div className="relative z-10 flex w-full flex-col items-center justify-center gap-6 px-12">
          <div className="w-96 text-center">
            ...
            <p className="mt-2 text-base text-gray-400 leading-relaxed">Manage inventory, sales, prescriptions, and staff — all in one place.</p>
          </div>
          ...
          <div className="flex w-96 flex-wrap justify-center gap-3">
            {["POS & Sales", "Inventory", "Prescriptions", "Insurance", "Reports", "Multi-Branch"].map((f) => (
              <span key={f} className="rounded-full bg-white/10 px-3 py-1 text-sm font-medium text-white border border-white/20">
                {f}
              </span>
            ))}
          </div>
