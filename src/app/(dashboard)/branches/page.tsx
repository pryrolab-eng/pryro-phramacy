...
import {
  ...
  AlertTriangle, Loader2, RefreshCw, TrendingUp, CreditCard,
  ArrowRight, MoreVertical, Pencil, Trash2, Crown, ChevronLeft,
} from 'lucide-react'
import { Spinner } from '@/components/ui/spinner'
import { toast } from 'sonner'
import {
  useSaasBranches, useCreateBranch, useUpdateBranch,
  useDeleteBranch, useSaasSubscription, useSaasPlans,
  useSubscribeToPlan,
} from '@/hooks/useSaasSubscription'
import type { Branch, BranchUsage, SubscriptionPlan } from '@/lib/saas/types'
...
export default function BranchesPage() {
  ...
  const hasSubscription = !!summary?.main_subscription
